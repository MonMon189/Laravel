...
<div class="wrapper">
        ...
        @endif
       <div class="header">
            <h1 class="left"><span class="sp1"><a href="{{route('article.index')}}">Article</a></span><span class="sp2">List</span></h1>
            <h1 class="right">
                    ...
                    <tbody>
                        @foreach($articles as $at)
                            <tr>
                                ...
                                <td>{{$at->Details}}</td>
                                <td>
                                    <form action="{{route('article.destroy', $at->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <span class="btn_edit"><a href="{{route('article.edit', $at->id)}}">Sửa</a></span>
